...
@Component({
  ...
  template: `
    ...
    <div mat-dialog-content>
      ...
      <ng-template [ngIf]="tome.attack || tome.defense || tome.health || tome.initiative || tome.power">
      ...
      <ng-template [ngIf]="tome.goldCost || tome.manaCost || tome.populationCost || tome.turnResearch || tome.turnCost">
      ...
      <ng-template [ngIf]="tome.goldMaintenance || tome.manaMaintenance || tome.populationMaintenance">
      ...
      <ng-template [ngIf]="tome.families?.length || tome.skills?.length || tome.categories?.length || tome.resistances?.length">
